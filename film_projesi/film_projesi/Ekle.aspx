<%@ Page Title="" Language="C#" MasterPageFile="~/yonetici.Master" AutoEventWireup="true" CodeBehind="Ekle.aspx.cs" Inherits="film_projesi.Ekle" %>
                ...
                <table>
                    ...
                    <tr>
                        <td colspan="2" class="btn-container">
                            <asp:Button ID="btnEkle" runat="server" CssClass="btn" Text="Ekle" OnClick="Button1_Click" />
                        </td>
                    </tr>
                </table>

                <asp:Label ID="lblEklendi" runat="server" CssClass="success-msg" Visible="false" Text="EKLENDİ !"></asp:Label>
                <br />
